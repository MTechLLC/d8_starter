...
if [[ -f ${HOME}/vendor-cache/$cachefile ]]; then echo "Delete previous cache archive"; rm -fv ${HOME}/vendor-cache/$cachefile; echo "Done"; mkdir ${HOME}/vendor-cache; else echo "No cache archive to delete"; fi
